...
export class UserDescriptorService {
	...
	/**
	 * Abstraction for GlobalDescriptor (smart contract) method, getLatestValueForUnit(unit: string): number
	 * See ./contracts/GlobalDescriptor.sol for the actual contract method
	 * @param accountId ID of the account sending the request (Local blockchain autogenerates 10 accounts to use)
	...
	/**
	 * Abstraction for GlobalDescriptor (smart contract) method, getAllValuesRecordedForUnit(unit: string): number[]
	 * See ./contracts/GlobalDescriptor.sol for the actual contract method
	 * @param accountId ID of the account sending the request (Local blockchain autogenerates 10 accounts to use)
	 * @param unit A unit such as lb, cm, miles, kilometer, etc
	 * @param gas Optional paramter, defaults to 5,000,000. Need gas to perform any sort of operation.
	...
	/**
	 * Abstraction for GlobalDescriptor (smart contract) method, getAllAvailableUnitForUser(): string[]
	 * See ./contracts/GlobalDescriptor.sol for the actual contract method
	 * @param accountId ID of the account sending the request (Local blockchain autogenerates 10 accounts to use)
	 * @param gas Optional paramter, defaults to 5,000,000. Need gas to perform any sort of operation.
	 */
